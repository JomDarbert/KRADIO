 ...
 */
var client_id, currentTime, endTime, exclude_tags, getActivePlayer, getRandomSong, getReadyPlayer, getTimeFromSecs, hangul, hangul_chars, logEvent, nextButton, pad, playButton, player_five, player_four, player_one, player_three, player_two, preparePlayer, priority_tags, seek, setActivePlayer, song_title, top_queries,
...
$("#nextButton").click(function() {
  ...
  next.play();
  return console.log("currently playing (" + next.id + ")" + next.getAttribute("title"));
});
...
$(document).ready(function() {
  return preparePlayer(player_one).done(function(player) {
    ...
    return preparePlayer(player_five);
  });
});
