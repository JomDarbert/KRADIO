 ...
 */
var client_id, container, currentTime, endTime, exclude_tags, eyk, getActivePlayer, getRandomSong, getReadyPlayer, getTimeFromSecs, hangul, hangul_chars, logEvent, mwave, nextButton, pad, playButton, playNext, player_five, player_four, player_one, player_three, player_two, preparePlayer, priority_tags, seek, setActivePlayer, song, song_title, top_queries, _i, _j, _len, _len1,
...
setActivePlayer = function(player) {
  var isActive, p, players, _k, _len2;
...
getRandomSong = function() {
  ...
  SC.get('/tracks', {
    ...
    var add_criteria, approved_songs, artwork, blacklisted, duration, genre, priority_songs, ret_song, sURL, stream_url, tag, tag_list, tags, term, title, track, untagged_songs, _k, _l, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _p;
    ...
    for (_k = 0, _len2 = tracks.length; _k < _len2; _k++) {
      ...
      for (_l = 0, _len3 = exclude_tags.length; _l < _len3; _l++) {
        term = exclude_tags[_l];
        if (title.indexOf(term) !== -1) {
          blacklisted += 1;
        }
      }
      for (_m = 0, _len4 = exclude_tags.length; _m < _len4; _m++) {
        term = exclude_tags[_m];
     ...
     */
    for (_o = 0, _len6 = approved_songs.length; _o < _len6; _o++) {
      song = approved_songs[_o];
      if (song.genre == null) {
        genre = "";
      } else {
        genre = song.genre.toLowerCase();
      ...
      if (tag_list.length > 0) {
        for (_p = 0, _len7 = tag_list.length; _p < _len7; _p++) {
          tag = tag_list[_p];
