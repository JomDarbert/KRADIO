...
top_queries     = [ "Madtown YOLO"
                    ...
                    "Song Ji Eun 25"
                    "Roy Kim Home"
                    "Epik High Spoiler + Happen Ending"
                    "Girl's Day I Miss You"
                    "Seo In Young Thinking Of You"
                    "Jay Park NaNa"
                    ...
                    "Bernard Park I'm"
                    "AlphaBAT A-Ya"
                    "Zia & Hwanhee Falling In Love"
                    "So You, Kwon Soonil & Park Yongin The Space Between"
                    "Lena Park & Verbal Jint Sweet"
                    "Roydo Look Around"
                    "Gaeko Rose"
                    "Muzie & Shin Hyun Joon Hero"
                    ...
                    "Suki Yesterday"
                    "Nam Young Joo Because I'm Soft And Kind"
                    "Juniel I Think I'm In Love"
                    "BeatBurger She So High"
                    "Almeng Phone In Love"
                    "Hyangni Be My First Love"
                    "Ku Hye Sun Floral Rain"
                    "Ruel Fly High"
                    "Jung Dong Ha If I"
                    "Gavy NJ I Wish"
                    "TROY Why are we"
                    ...
                    "Yoon Jong Shin Men Without Women"
                    "Roo Baby I Love You"
                    "High4 Headache"
                    "Beat Win Illusion"
                    "EXID Up and Down"
